...
async function processDueSells(userId) {
  if (!supabase) return;
  const now = new Date();
  try {
    const { data: u } = await supabase
      .from('users')
      .select('id, email, wallet_balance, total_profits, pending_sells, notifications')
      .eq('id', userId)
      .single();
    if (!u) return;
    ...
    for (const ps of dueSells) {
      const product      = PRODUCTS.find(p => p.id === Number(ps.productId));
      ...
      console.log(`Sold ${ps.productName} for ${u.email} — ${saleAmount} FCFA (profit: ${profitAmount} FCFA)`);
    }
    ...
    console.error('processDueSells error:', err.message);
  }
}
...
app.get('/api/users/profile', async (req, res) => {
  ...
  try {
    ...
    // Process any due sells before returning profile data
    await processDueSells(user.id);

    // Re-fetch so the balance reflects any sells just processed
    const updatedUser = await getUserByToken(token);
    const { password, ...publicData } = updatedUser || user;
    res.json(publicData);
  } catch (err) {
...
const PRODUCTS = [
  { id: 1,  name: '📱 Smartphone',         price: 10000,  stock: 50,  category: 'Electronics',     minVip: null    },
  { id: 2,  name: '🎧 Headphones',          price: 2000,   stock: 100, category: 'Audio',           minVip: null    },
  { id: 3,  name: '💻 Laptop',              price: 25000,  stock: 30,  category: 'Electronics',     minVip: 'vip2'  },
  { id: 4,  name: '📷 Camera',              price: 15000,  stock: 20,  category: 'Photography',     minVip: 'vip2'  },
  { id: 5,  name: '⌚ Smartwatch',           price: 8000,   stock: 40,  category: 'Wearables',       minVip: 'vip2'  },
  { id: 6,  name: '🎮 Gaming Console',      price: 12000,  stock: 25,  category: 'Gaming',          minVip: 'vip3'  },
  { id: 7,  name: '📺 Smart TV',            price: 35000,  stock: 15,  category: 'Electronics',     minVip: 'vip3'  },
  { id: 8,  name: '🎹 Digital Piano',       price: 50000,  stock: 10,  category: 'Musical',         minVip: 'vip3'  },
  { id: 9,  name: '🏎️ Premium Electronics', price: 45000,  stock: 12,  category: 'Premium',         minVip: 'vip4'  },
  { id: 10, name: '💎 Jewelry',             price: 50000,  stock: 8,   category: 'Luxury',          minVip: 'vip4'  },
  { id: 11, name: '✈️ Travel Vouchers',     price: 100000, stock: 20,  category: 'Travel',          minVip: 'vip4'  },
  { id: 12, name: '💍 Luxury Items',        price: 100000, stock: 5,   category: 'Luxury',          minVip: 'vip5'  },
  { id: 13, name: '🛥️ Exclusive Access',    price: 150000, stock: 3,   category: 'Premium Services',minVip: 'vip5'  },
  { id: 14, name: '🌍 Global Benefits',     price: 200000, stock: 2,   category: 'Premium Services',minVip: 'vip5'  },
  { id: 15, name: '🏢 Real Estate Access',  price: 300000, stock: 5,   category: 'Real Estate',     minVip: 'vip6'  },
  { id: 16, name: '🎭 Entertainment',       price: 250000, stock: 4,   category: 'Entertainment',   minVip: 'vip6'  },
  { id: 17, name: '🏊 Resort Membership',   price: 350000, stock: 3,   category: 'Lifestyle',       minVip: 'vip6'  },
  { id: 18, name: '💼 Business Package',    price: 500000, stock: 3,   category: 'Business',        minVip: 'vip7'  },
  { id: 19, name: '🌟 Platinum Benefits',   price: 600000, stock: 2,   category: 'Premium Services',minVip: 'vip7'  },
  { id: 20, name: '🎯 Elite Access',        price: 700000, stock: 1,   category: 'Elite',           minVip: 'vip7'  },
];

const PLANS_DATA = [
  { id: 'vip1', name: 'VIP 1', price: 10000,  dailyProfit: 333,   weeklyProfit: 2333,   monthlyProfit: 10000  },
  { id: 'vip2', name: 'VIP 2', price: 25000,  dailyProfit: 833,   weeklyProfit: 5833,   monthlyProfit: 25000  },
  { id: 'vip3', name: 'VIP 3', price: 50000,  dailyProfit: 1667,  weeklyProfit: 11669,  monthlyProfit: 50000  },
  { id: 'vip4', name: 'VIP 4', price: 100000, dailyProfit: 3333,  weeklyProfit: 23333,  monthlyProfit: 100000 },
  { id: 'vip5', name: 'VIP 5', price: 200000, dailyProfit: 6667,  weeklyProfit: 46667,  monthlyProfit: 200000 },
  { id: 'vip6', name: 'VIP 6', price: 400000, dailyProfit: 13333, weeklyProfit: 93333,  monthlyProfit: 400000 },
  { id: 'vip7', name: 'VIP 7', price: 800000, dailyProfit: 26667, weeklyProfit: 186667, monthlyProfit: 800000 },
];

app.get('/api/products', (req, res) => res.json(PRODUCTS));
app.get('/api/plans',    (req, res) => res.json(PLANS_DATA));
...
app.get('/api/admin/pending-withdrawals', async (req, res) => {
  ...
  try {
    ...
    return res.json((data || []).map(w => ({
      ...
      adminModified:        w.admin_modified,
      adminNote:            w.admin_note,
      originalAmount:       w.original_amount,
      originalPhoneNumber:  w.original_phone_number,
    })));
  } catch (err) {
